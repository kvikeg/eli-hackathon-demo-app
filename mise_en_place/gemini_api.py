...
# simple model call
def simple_call():
    response = client.models.generate_content(model="gemini-2.0-flash", contents="Why is the sky green?")
    print(response.text)
...
def multi_modal():
    ...
    response = client.models.generate_content(model="gemini-2.0-flash", contents=["question", uploaded_file])
    print(response.text)
